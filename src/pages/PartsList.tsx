...
import { selectPartListRefetchToggle } from "../redux/slices/partListRefetchSlice";
...
export default function PartList(props: Props) {
  ...
  const { data, error, isFetching } = useQuery({
    ...
    queryFn: async ({ queryKey }) => {
      const response = await window.select.selectPaginatedParts({
